...
test("dashboard names live gameplay modes, actions, and dungeon reasons in Russian", () => {
  for (const label of [
    "Обычная жизнь героя", "Ожидание группы", "Полигон", "Возраст heartbeat", "Нет подходящего действия по текущим правилам", "Атака влиянием", "Глас: Лечись!", "Глас: Бей!", "Восстановление праны", "Запуск ZPG-арены",
